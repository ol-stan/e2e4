...
function wpshop_core_metabox() {
    ...
    class Posts_Meta_Box extends Vetteo_Meta_Box {
        ...
        public function __construct() {
            $this->set_settings( 'meta_posts_', 'post', __( 'Root: Post settings', THEME_TEXTDOMAIN ), 'advanced' );
    ...
    class Pages_Meta_Box extends Vetteo_Meta_Box {
        ...
        public function __construct() {
            $this->set_settings( 'meta_pages_', 'page', __( 'Root: Page settings', THEME_TEXTDOMAIN ), 'advanced' );
