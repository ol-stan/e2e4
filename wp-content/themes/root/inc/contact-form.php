...
function contact_form_isif_life( $atts ){
    ...
    <div id="contact_form" class="contact-form">
        <?php if( isset( $emailSent ) && $emailSent == true ) { ?>
            <div class="contact_message"><?php _e( 'Your message was successfully sent!', THEME_TEXTDOMAIN ) ?></div>
        <?php } else { ?>
            ...
            <form action="<?php the_permalink(); ?>" method="post">
                ...
                <div class="contact_left">
                    <div class="contact_name">
                        <input type="text" placeholder="<?php _e( 'Your name', THEME_TEXTDOMAIN ) ?>" name="contact_name" id="contact_name" value="<?php if( isset( $_POST['contact_name'] ) ) echo $_POST['contact_name'];?>" class="required requiredField" />
                    ...
                    <div class="contact_theme">
                        <input type="text" placeholder="<?php _e( 'Subject', THEME_TEXTDOMAIN ) ?>" name="contact_theme" id="contact_theme" value="<?php if( isset( $_POST['contact_theme'] ) ) echo $_POST['contact_theme'];?>" class="required requiredField" />
                ...
                <div class="contact_right">
                    <div class="contact_textarea">
                        <textarea placeholder="<?php _e( 'Message', THEME_TEXTDOMAIN ) ?>" name="contact_comments" id="commentsText" rows="12" cols="56" class="required requiredField"><?php if( isset( $_POST['contact_comments'] ) ) { if( function_exists( 'stripslashes' ) ) { echo stripslashes( $_POST['contact_comments'] ); } else { echo $_POST['contact_comments']; } } ?></textarea>
                    ...
                    <button type="contsubmit" class="contact_submit"><?php _e( 'Send', THEME_TEXTDOMAIN ) ?></button>
