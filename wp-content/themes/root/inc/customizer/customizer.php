...
function root_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 'root_options[structure_arrow_icon]', array(
        ...
        'choices'           => array(
            '\f102'         => __( 'Двойная кавычка вверх', THEME_TEXTDOMAIN ),
            '\f106'         => __( 'Кавычка вверх', THEME_TEXTDOMAIN ),
            '\f139'         => __( 'Стрелка в круге', THEME_TEXTDOMAIN ),
            '\f148'         => __( 'Стрелка вверх', THEME_TEXTDOMAIN ),
            '\f151'         => __( 'Стрелка в квадрате', THEME_TEXTDOMAIN ),
            '\f176'         => __( 'Стрелка вверх 2', THEME_TEXTDOMAIN ),
            '\f01b'         => __( 'Стрелка в круге 2', THEME_TEXTDOMAIN ),
            '\f077'         => __( 'Стрелка вверх 2', THEME_TEXTDOMAIN ),
        ),
    ) );
