...
function wpshop_core_thumbnails() {
    ...
    class Posts_Thumbnails extends Vetteo_Meta_Box {
        ...
        public function __construct() {
            $this->set_settings( 'posts_thumb_', 'post', __( 'Thumbnail settings', THEME_TEXTDOMAIN ), 'side' );
    ...
    class Pages_Thumbnails extends Vetteo_Meta_Box {
        ...
        public function __construct() {
            ...
            $this->set_settings( 'pages_thumb_', 'page', __( 'Thumbnail settings', THEME_TEXTDOMAIN ), 'side' );
