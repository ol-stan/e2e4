...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number(__('No Comments'), __('1 Comment'), __('% Comments'));?> к &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3><?php comment_form_title( 'Оставить отзывы', 'Оставить отзывы к %s' ); ?></h3>
